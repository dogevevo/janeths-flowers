                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-menu-widget clearfix">
                            <h4 class="footer-title">Janeth's Flowers </h4>
                            <div class="footer-menu">
                               <img class="size-img" src="img/logo-r.png" alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget footer-about-widget">
                            ...
                            <div class="footer-address">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="tel:+0123-456789"><?php echo $Phone?></a></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-address-icon">
                                        ...
                                        <div class="footer-address-info">
                                            <p><a href="mailto:example@example.com"><?php echo $Domain ?> </a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div class="ltn__social-media mt-20 d-none">
                                <ul>
                                    ...
                                    <li><a href="https://twitter.com/?lang=es" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-md-6 col-12 align-self-center">
                        <div class="footer-copyright-right text-right">
                            ...
                            <div class="ltn__social-media ">
                                <ul>
                                    <li><a href="https://www.facebook.com/" title="Facebook"><i class="icon-social-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/?lang=es" title="Twitter"><i class="icon-social-twitter"></i></a></li>
                                    <li><a href="https://www.pinterest.es/" title="Pinterest"><i class="icon-social-pinterest"></i></a></li>
                                    <li><a href="https://www.instagram.com/" title="Instagram"><i class="icon-social-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
